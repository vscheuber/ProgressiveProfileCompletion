 ...
 * @since AM 5.5.0
 */
public class ProgressiveProfileCompletionNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ProgressiveProfileCompletionNodePlugin.currentVersion, 
				Collections.singletonList(ProgressiveProfileCompletionNode.class));
	}
	...
	public void upgrade(String fromVersion) throws PluginException {
	  pluginTools.upgradeAuthNode(ProgressiveProfileCompletionNode.class);
	}
	...
	public String getPluginVersion() {
		return ProgressiveProfileCompletionNodePlugin.currentVersion;
	}
}
